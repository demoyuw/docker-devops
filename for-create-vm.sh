...
for ((i=9; i<=10; i++))
do
    gcloud compute --project=cedar-card-352414 instances create devops-cicd-vm2-$i \
    ...
    --tags=http-server,https-server --image=ubuntu-2004-focal-v20220701 --image-project=ubuntu-os-cloud \
